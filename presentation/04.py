...
# Stochastic Gradient Descent, esattamente il "p -= lr * p.grad"
# "stocastica" perche' di solito ogni passo si calcola su un campione casuale di esempi invece che su tutti
